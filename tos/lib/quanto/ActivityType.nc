...
interface ActivityType {
    ...
    /* Returns the activity_type part of c, or QUANTO_ACTIVITY(UNKNOWN) if c is NULL */
     ...
     * Sets node to TOS_NODE_ID and activity to QUANTO_ACTIVITY(UNKNOWN) 
     */
     ...
     * Sets node to ACT_NODE_INVALID and activity to QUANTO_ACTIVITY(UNKNOWN).
